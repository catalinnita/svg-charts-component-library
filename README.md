...
- `@scrambled-data/core`: core React components
- `@scrambled-data/utils`: shared React utilities
- `@scrambled-data/tsconfig`: shared `tsconfig.json`s used throughout the monorepo
